                ...
                <div class="container-fluid">
                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
                        ...
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="admin.php">New Order</a>
                            </li>
                        </ul>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-chevron p-3 b bg-white rounded-3">
      ...
      <li class="breadcrumb-item">
            <a class="link-body-emphasis fw-semibold text-decoration-none" href="editcustomer.php">Edit Customer</a>
      </li>
      <li class="m-2">
...
<?php
    ...
    //checking if customer_id is set in the URL
    if (isset($_GET['customer_id'])) {
        $customer_id = $_GET['customer_id'];
        // Retrieve data for the specified customerid
        ...
        ?>
        <form method="POST" action="customer_update.php?customer_id=<?php echo $customer_id; ?>">
            <label>Customer Name:</label><input type="text" value="<?php echo $row['customer_name']; ?>" name="customer_name">
            <label>Customer Phone Number:</label><input type="text" value="<?php echo $row['customer_phonenumber']; ?>" name="customer_phone">
            <label>Customer Email:</label><input type="text" value="<?php echo $row['customer_email']; ?>" name="customer_email">
