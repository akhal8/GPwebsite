...
<nav aria-label="breadcrumb">
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5"/>
      ...
      <li class="breadcrumb-item">
        <a class="link-body-emphasis fw-semibold text-decoration-none" href="edit.php">Edit Product</a>
      </li>
      <li class="m-2">
    ...
    //checking if product_id is set in the URL
    if (isset($_GET['ProductId'])) {
        $ProductId = $_GET['ProductId'];
        // Retrieve data for the specified ProductId
        $query = mysqli_query($con, "SELECT * FROM `Products` WHERE ProductId='$ProductId'");
        $row = mysqli_fetch_array($query);

        // following is the code for the form to insert data into db
        ?>
        <form method="POST" action="update.php?ProductId=<?php echo $ProductId; ?>">
            ...
            <label>Product Quantity:</label><input type="text" value="<?php echo $row['ProductQuantity']; ?>" name="ProductQuantity">
            <label>Product Expiry:</label><input type="text" value="<?php echo $row['ProductExpiry']; ?>" name="ProductExpiry">
