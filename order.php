...
<html lang="en">
    ...
    <!-- following code is used to connect bootstrap css and js-->
    <script
    ...
    <style>
        body {
            padding-bottom: 5px; /* Adjusted to accommodate the fixed footer */
            margin: 0;
            }
...
<script>
        ...
        async function updatePrice() {
            ...
            // updating the total price with all the products prices.
            document.getElementById("totalPrice").innerText = "Total Price: $" + totalPrice.toFixed(2);
        }
    </script>
</head>
<body>
    <!-- following id is used for the zoom function-->
    <div id="content">
     ...
     <!-- following code is for the title heading and the navbar which includes the links-->
        ...
        <!-- following code is for displaying quantity notification -->
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-chevron p-3  bg-white rounded-3">
            ...
            <li class="breadcrumb-item">
            <a class="link-body-emphasis fw-semibold text-decoration-none" href="order.php">New Order</a>
            </li>
            <li>
        ...
        mysqli_free_result($product_result);
                ...
                if ($product_result) {
                    while ($row = mysqli_fetch_assoc($product_result)) {
                        ...
                        //checking if any product is under five and showing an alert if it is.
